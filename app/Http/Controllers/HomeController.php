...
class HomeController extends BaseController
{
    ...
    public function index()
    {
        ...
        $photoalbums = PhotoAlbum::select(['photo_album.id', 'photo_album.name', 'photo_album.description',
        ...
        $videoalbums = VideoAlbum::select(['video_album.id', 'video_album.name', 'video_album.description',
